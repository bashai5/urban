...
Примечания:
- Не забывайте для удобства использовать dunder(магические) методы: __str__, __repr__, __contains__, __eq__ и др. (повторить можно здесь https://docs.python.org/3/reference/datamodel.html#basic-customization)
